...
The project contains some pre-written unit tests which will test the code you write.  Because Swift is a case sensitive language (as most are), you must take extra caution in making sure your names match the specification given in this playground precisely; if they do not, the tests will not compile properly.  Once your implementation is finished you will be able to choose the "Test" option from the "Product" menu in order to run the tests and make sure that your implementation is correct.  If any tests fail, examine the failure messages for an indication of where the bug in your code is.
